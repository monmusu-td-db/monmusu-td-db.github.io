...
function BoxArrowUpRight({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function CaretDownFill({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function CaretUpFill({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function DiskFill({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function DropletFill({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function ExclamationDiamondFill({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function Fire({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function GitHub({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function GlobeAsiaAustralia({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function Hurricane({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function InfoFill({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function LightningChargeFill({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
...
function TwitterX({ width, height }: Props) {
  width ??= 16;
  height ??= 16;
  return (
    <svg
