    ...
    <PageRoot pageType="situation">
      ...
      <Container className="md-content mt-5">
        ...
        <dl>
          <dt>1. 内容</dt>
          <dd>
            効果の内容で、デバフや状態異常耐性などがあります。
            この場合、敵に15%の攻撃力デバフを与えることを示しています。
          </dd>
          <dt>2. 時間・確率</dt>
          <dd>
            効果時間や確率、そのほか補足説明が含まれています。
            例文では、デバフが10秒間持続することを示しています。
            未表記の場合、配置中永続する効果です。
          </dd>
          <dt>3. 頻度・発生タイミング</dt>
          <dd>
            ...
            「5秒」と表記されていれば5秒ごとに有効になります。
            未表記の場合、常時発動する効果です。
          </dd>
          <dt>4. 対象</dt>
          <dd>
            効果対象です。
            「命中」ならば攻撃や回復のヒット時、「射程内」なら射程内の敵もしくは味方です。
            特記なき場合、バフ効果は味方のみ、デバフ効果は敵にのみ対象となります。
            未表記の場合、自身のみ対象の効果です。
          </dd>
        </dl>
        <h3>補足項目の略語</h3>
        ...
        <dl>
          <dt>出撃前能力</dt>
          <dd>
            出撃前のキャラクター画面で表示されている能力値です。
            基礎値に加えて、設定に応じて潜在覚醒、専用武器、サブスキルなどが適用されています。
          </dd>
          <dt>配置前能力</dt>
          <dd>
            配置前にキャラクターをつかんだ際に表示される能力値です。
            出撃前能力に編成バフ、獣神バフ、獣神効果、タイプボーナスなどが適用されます。
          </dd>
          <dt>戦闘中能力</dt>
          <dd>
            戦闘中にキャラクターを選択した際に表示される能力値です。
            配置前能力に乗算バフや加算バフが適用された値が表示されます。
          </dd>
          <dt>実攻撃力</dt>
          <dd>戦闘中能力値にダメージ倍率を適用した値です。</dd>
          <dt>
            <small>(CRI率)</small>CRI攻撃力
          </dt>
          <dd>
            戦闘中能力値にダメージ倍率とクリティカルダメージ倍率を適用した値です。
            先頭のカッコの中身はクリティカル率を表します。
          </dd>
          <dt>固有値</dt>
          <dd>実際の能力値とは異なる値を表します。</dd>
          <dd>
            <Example>
              <p>
        ...
        <dl>
          <dt>攻撃動作速度</dt>
          <dd>攻撃のモーション部分のフレーム数です。</dd>
          <dt>攻撃待機時間</dt>
          <dd>攻撃後の硬直時間のフレーム数です。</dd>
          <dt>攻撃間隔</dt>
          <dd>
            攻撃動作速度と攻撃待機時間を加算した、攻撃一回当たりにかかるフレーム数です。
          </dd>
          <dt>単発スキル発動間隔</dt>
          <dd>
            曲刀クラスのEXスキルのように、持続時間が短いスキルの発動する間隔です。
          </dd>
        </dl>
        <h3>物理・魔法ワンパン</h3>
        <dl>
          ...
          <dd>
            一撃で撃破される敵攻撃力を表しています。
            この値から1を引いた攻撃力までは耐えられることになります。
          </dd>
          <dd>
            なお敵に割合デバフを与える場合、
            敵の基礎攻撃力とバフ量に応じてデバフ量が変化しますが、
            ここの表示では敵のバフやデバフは考慮していませんのでご了承ください。
          </dd>
          <dt>攻撃回避率</dt>
          <dd>ユニットの物理もしくは魔法攻撃回避率です。</dd>
        </dl>
        <h2>表の色分け・強調表示</h2>
